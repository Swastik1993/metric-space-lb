...
echo
echo "Done. Submit one of the slurm scripts:"
echo "  sbatch sift50k_smoke.slurm    # ~30-60 min, verify the binary works"
echo "  sbatch sift50k_k256.slurm     # ~6-8h,  k=256, s=500"
echo "  sbatch sift50k_k512.slurm     # ~18-22h, k=512, s=1000"
